...
namespace CSharpTesterDemoCoreMicrosoftGuide.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
            ...
            IEmailSender emailSender)
        {
            ...
            // TODO ckerer: we should only do this once - where the sign-in manager gets created!
            // Configure our own claims factory ...
            ////var previousFactory = _signInManager.ClaimsFactory;
            ////_signInManager.ClaimsFactory = new TestClaimsFactory(_signInManager, previousFactory);
